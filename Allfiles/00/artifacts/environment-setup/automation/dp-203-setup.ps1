...
Write-Host "Your randomly-generated suffix for Azure resources is" 
Write-Host $suffix -ForegroundColor yellow -BackgroundColor Red
...
$preferred_list = "australiaeast","centralus","eastus2","northeurope", "southeastasia","uksouth","westeurope","westus","westus2"
